...
check the box of the `ecoli.cmp.csv`, click more settings, and select export. This will download to your downloads folder, and then you can drag it into your lab_14 folder. repeat for `ecoli_compare_table.csv`, the binder requires that you download one at a time!
```{r}
library(tidyverse)
```
